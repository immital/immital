...
! function(e) {
    ...
    function e(e, t) {
        return t = t || T, R.test(e) ? t.getElementsByClassName(e.slice(1)) : V.test(e) ? t.getElementsByTagName(e) : t.querySelectorAll(e)
    }

    function t(e) {
        if (!M) {
            var t = (M = T.implementation.createHTMLDocument()).createElement("base");
            t.href = T.location.href, M.head.appendChild(t)
        }
    ...
    function n(n, s) {
        ...
        var a, o = n,
            r = 0;
        if (I(n)) o = P.test(n) ? T.getElementById(n.slice(1)) : H.test(n) ? t(n) : e(n, s);
        else if (A(n)) return i(n), this;
        if (!o) return this;
        if (o.nodeType || o === L) this[0] = o, this.length = 1;
        else
            for (a = this.length = o.length; r < a; r++) this[r] = o[r];
        return this
    }
    ...
    function d(e, t) {
        var i = h(e);
        return void 0 === i[t] && (i[t] = e.dataset ? e.dataset[t] : s(e).attr("data-" + t)), i[t]
    }
    ...
    function y(e, t, i) {
        ...
        n[t] = n[t] || [], n[t].push(i), e.addEventListener(t, i)
    }

    function _(e, t, i) {
        var n, s = d(e, "_cashEvents"),
            o = s && s[t];
        o && (i ? (e.removeEventListener(t, i), (n = o.indexOf(i)) >= 0 && o.splice(n, 1)) : (a(o, function(i) {
    ...
    var M, T = document,
        ...
        H = /<.+>/,
        V = /^\w+$/,
        W = s.fn = s.prototype = n.prototype = {
            cash: !0,
            length: 0,
            push: D,
            splice: $.splice,
    ...
    Object.defineProperty(W, "constructor", {
        value: s
    }), s.parseHTML = t, s.noop = O, s.isFunction = A, s.isString = I, s.extend = W.extend = function(e) {
        e = e || {};
    ...
    W.extend({
        data: function(e, t) {
            if (I(e)) return void 0 === t ? d(this[0], e) : this.each(function(i) {
                return u(i, e, t)
            });
    ...
    W.extend({
        ...
        attr: function(e, t) {
            if (e) {
                if (I(e)) return void 0 === t ? this[0] ? this[0].getAttribute ? this[0].getAttribute(e) : this[0][e] : void 0 : this.each(function(i) {
        ...
        prop: function(e, t) {
            if (I(e)) return void 0 === t ? this[0][e] : this.each(function(i) {
                i[e] = t
            });
    ...
    var N = function() {
        ...
        z = function() {
            ...
            return function(i) {
                if (i = N(i), e[i]) return e[i];
                var n = i.charAt(0).toUpperCase() + i.slice(1);
                return a((i + " " + ["webkit", "moz", "ms", "o"].join(n + " ") + n).split(" "), function(n) {
                    if (n in t) return e[n] = i = e[i] = n, !1
                }), e[i]
            }
        }();
    s.prefixedProp = z, s.camelCase = N, W.extend({
        css: function(e, t) {
            if (I(e)) return e = z(e), arguments.length > 1 ? this.each(function(i) {
                return i.style[e] = t
        ...
        on: function(e, t, n, s) {
            ...
            return A(t) && (n = t, t = null), "ready" === e ? (i(n), this) : (t && (a = n, n = function(e) {
                for (var i = e.target; !o(i, t);) {
                    if (i === this) return i = !1;
                    i = i.parentNode
                }
                i && a.call(i, e)
                ...
                var i = n;
                s && (i = function() {
                    n.apply(this, arguments), _(t, e, i)
                }), y(t, e, i)
            }))
        },
        one: function(e, t, i) {
        ...
        after: function(e) {
            return s(e).insertAfter(this), this
        },
        append: function(e) {
            return x(this, e), this
        },
        appendTo: function(e) {
            return x(s(e), this), this
        },
        before: function(e) {
            return s(e).insertBefore(this), this
        },
        clone: function() {
    ...
    return W.extend({
        ...
        find: function(t) {
            if (!t || t.nodeType) return s(t && this.has(t).length ? t : null);
            var i = [];
            return this.each(function(n) {
                D.apply(i, e(t, n))
            }), l(i)
        ...
        parents: function(e) {
            var t, i = [];
            return this.each(function(n) {
                for (t = n; t && t.parentNode && t !== T.body.parentNode;) t = t.parentNode, (!e || e && o(t, e)) && i.push(t)
            }), l(i)
        },
        prev: function() {
    ...
    if (!e.jQuery) {
        ...
        i.isWindow = function(e) {
            ...
            if (n) {
                ...
                for (s in e)
                    if (e.hasOwnProperty(s) && !1 === i.call(e[s], s, e[s])) break;
            return e
            ...
            var e, t, n, s, a, o, r = arguments[0] || {},
                l = 1,
                h = arguments.length,
                u = !1;
            for ("boolean" == typeof r && (u = r, r = arguments[l] || {}, l++), "object" != typeof r && "function" !== i.type(r) && (r = {}), l === h && (r = this, l--); l < h; l++)
                if (a = arguments[l])
                    for (s in a) a.hasOwnProperty(s) && (e = r[s], n = a[s], r !== n && (u && n && (i.isPlainObject(n) || (t = i.isArray(n))) ? (t ? (t = !1, o = e && i.isArray(e) ? e : []) : o = e && i.isPlainObject(e) ? e : {}, r[s] = i.extend(u, o, n)) : void 0 !== n && (r[s] = n)));
            return r
...
function(e) {
    ...
    return function(e, t, i, n) {
        ...
        function u(e, i, n, s) {
            ...
            function d() {
                for (var t = 0; t < _; ++t) C[t] = l(t * k, e, n)
            }
            ...
            function p(t) {
                for (var i = 0, s = 1, a = _ - 1; s !== a && C[s] <= t; ++s) i += k;
            ...
            var C = b ? new Float32Array(_) : new Array(_),
                E = !1,
                x = function(t) {
                    return E || v(), e === i && n === s ? t : 0 === t ? 0 : 1 === t ? 1 : l(p(t), i, s)
                };
        ...
        function d(e, t) {
            var i = e;
            return _.isString(e) ? C.Easings[e] || (i = !1) : i = _.isArray(e) && 1 === e.length ? h.apply(null, e) : _.isArray(e) && 2 === e.length ? E.apply(null, e.concat([t])) : !(!_.isArray(e) || 4 !== e.length) && u.apply(null, e), !1 === i && (i = C.Easings[C.defaults.easing] ? C.defaults.easing : w), i
        }
                ...
                for (var a = 0; a < i; a++)
                    if (C.State.calls[a]) {
                        var r = C.State.calls[a],
                            ...
                            y = r[5],
                            k = r[6];
                        if (u || (u = C.State.calls[a][3] = t - 16), y) {
                            if (!0 !== y.resume) continue;
                            u = r[3] = Math.round(t - k - 16), r[5] = null
                        }
                        k = r[6] = t - u;
                            ...
                            if (o(L)) {
                                ...
                                for (var B in M)
                                    if (M.hasOwnProperty(B) && "element" !== B) {
                                        var D, O = M[B],
                                            A = _.isString(O.easing) ? C.Easings[O.easing] : O.easing;
                                        ...
                                        if (O.currentValue = D, "tween" === B) m = D;
                                            ...
                                            x.Hooks.registered[B] && (x.Normalizations.registered[R] ? o(L).rootPropertyValueCache[R] = x.Normalizations.registered[R]("extract", null, V[1]) : o(L).rootPropertyValueCache[R] = V[1]), "transform" === V[0] && ($ = !0)
                                        }
                                    }
                                h.mobileHA && o(L).transformCache.translate3d === n && (o(L).transformCache.translate3d = "(0px, 0px, 0px)", $ = !0), $ && x.flushTransformCache(L)
                            }
                        }
                        h.display !== n && "none" !== h.display && (C.State.calls[a][2].display = !1), h.visibility !== n && "hidden" !== h.visibility && (C.State.calls[a][2].visibility = !1), h.progress && h.progress.call(r[1], r[1], b, Math.max(0, u + h.duration - t), u, m), 1 === b && p(a)
                    }
            }
        ...
        function p(e, t) {
            ...
            for (var i = C.State.calls[e][0], s = C.State.calls[e][1], a = C.State.calls[e][2], r = C.State.calls[e][4], l = !1, h = 0, u = i.length; h < u; h++) {
                var d = i[h].element;
                t || a.loop || ("none" === a.display && x.setPropertyValue(d, "display", a.display), "hidden" === a.visibility && x.setPropertyValue(d, "visibility", a.visibility));
                var c = o(d);
                if (!0 !== a.loop && (v.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(v.queue(d)[1])) && c) {
                    ...
                    v.each(x.Lists.transforms3D, function(e, t) {
                        ...
                        c.transformCache[t] !== n && new RegExp("^\\(" + i + "[^.]").test(s) && (p = !0, delete c.transformCache[t])
                    }), a.mobileHA && (p = !0, delete c.transformCache.translate3d), p && x.flushTransformCache(d), x.Values.removeClass(d, "velocity-animating")
                }
                if (!t && a.complete && !a.loop && h === u - 1) try {
                    a.complete.call(s, s)
                } catch (e) {
                    setTimeout(function() {
                        throw e
                ...
                r && !0 !== a.loop && r(s), c && !0 === a.loop && !t && (v.each(c.tweensContainer, function(e, t) {
        ...
        var v, f = function() {
            ...
            k = !1;
        if (e.fn && e.fn.jquery ? (v = e, k = !0) : v = t.Velocity.Utilities, f <= 8 && !k) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity."); {
            if (!(f <= 7)) {
                var b = 400,
                    w = "swing",
                    C = {
                ...
                var E = function() {
                    ...
                    return function e(t, n, s) {
                        var a, o, r, l = {
                            ...
                            h = [0],
                            u = 0;
                        for (t = parseFloat(t) || 500, n = parseFloat(n) || 20, s = s || null, l.tension = t, l.friction = n, (a = null !== s) ? (u = e(t, n), o = u / s * .016) : o = .016; r = i(r || l, o), h.push(1 + r.x), u += 16, Math.abs(r.x) > 1e-4 && Math.abs(r.v) > 1e-4;);
                        return a ? function(e) {
                ...
                var x = C.CSS = {
                    ...
                    Hooks: {
                        ...
                        injectValue: function(e, t, i) {
                            ...
                            if (n) {
                                var s, a = n[0],
                                    o = n[1];
                                return i = x.Hooks.cleanRootPropertyValue(a, i), s = i.toString().match(x.RegEx.valueSplit), s[o] = t, s.join(" ")
                            }
                            return i
                        }
                    },
                    Normalizations: {
                        ...
                        register: function() {
                            function e(e, t, i) {
                                if ("border-box" === x.getPropertyValue(t, "boxSizing").toString().toLowerCase() === (i || !1)) {
                                    var n, s, a = 0,
                                        ...
                                        r = ["padding" + o[0], "padding" + o[1], "border" + o[0] + "Width", "border" + o[1] + "Width"];
                                    for (n = 0; n < r.length; n++) s = parseFloat(x.getPropertyValue(t, r[n])), isNaN(s) || (a += s);
                                    return i ? -a : a
                                }
                                return 0
                            }
                                    ...
                                    switch (t) {
                                        ...
                                        case "inject":
                                            ...
                                            switch (e.substr(0, e.length - 1)) {
                                                ...
                                                case "scal":
                                                case "scale":
                                                    C.State.isAndroid && o(i).transformCache[e] === n && s < 1 && (s = 1), a = !/(\d)$/i.test(s);
                                                    break;
                                                case "skew":
                                                    a = !/(deg|\d)$/i.test(s);
                                                    break;
                            ...
                            for (var s = 0; s < x.Lists.colors.length; s++) ! function() {
                                ...
                                x.Normalizations.registered[e] = function(t, i, s) {
                                    switch (t) {
                                        ...
                                        case "extract":
                                            ...
                                            return (!f || f > 8) && 3 === a.split(" ").length && (a += " 1"), a;
                                        case "inject":
                                            return /^rgb/.test(s) ? s : (f <= 8 ? 4 === s.split(" ").length && (s = s.split(/\s+/).slice(0, 3).join(" ")) : 3 === s.split(" ").length && (s += " 1"), (f <= 8 ? "rgb" : "rgba") + "(" + s.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")")
                                    }
                                }
                            }();
                    ...
                    Names: {
                        ...
                        SVGAttribute: function(e) {
                            ...
                            return (f || C.State.isAndroid && !C.State.isChrome) && (t += "|transform"), new RegExp("^(" + t + ")$", "i").test(e)
                        },
                        prefixCheck: function(e) {
                            ...
                            for (var t = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = t.length; i < n; i++) {
                                ...
                                if (s = 0 === i ? e : t[i] + e.replace(/^\w/, function(e) {
                                    ...
                                    }), _.isString(C.State.prefixElement.style[s])) return C.State.prefixMatches[e] = s, [s, !0]
                            }
                            return [e, !1]
                        }
                    },
                    ...
                    getPropertyValue: function(e, i, s, a) {
                        function r(e, i) {
                            ...
                            if (f <= 8) s = v.css(e, i);
                                ...
                                var l = !1;
                                /^(width|height)$/.test(i) && 0 === x.getPropertyValue(e, "display") && (l = !0, x.setPropertyValue(e, "display", x.Values.getDisplayType(e)));
                                var h = function() {
                                ...
                                var c;
                                c = o(e) === n ? t.getComputedStyle(e, null) : o(e).computedStyle ? o(e).computedStyle : o(e).computedStyle = t.getComputedStyle(e, null), "borderColor" === i && (i = "borderTopColor"), "" !== (s = 9 === f && "filter" === i ? c.getPropertyValue(i) : c[i]) && null !== s || (s = e.style[i]), h()
                            }
                        ...
                        if (x.Hooks.registered[i]) {
                            var h = i,
                                u = x.Hooks.getRoot(h);
                            s === n && (s = x.getPropertyValue(e, x.Names.prefixCheck(u)[0])), x.Normalizations.registered[u] && (s = x.Normalizations.registered[u]("extract", e, s)), l = x.Hooks.extractValue(h, s)
                        } else if (x.Normalizations.registered[i]) {
                            var d, c;
                            "transform" !== (d = x.Normalizations.registered[i]("name", e)) && (c = r(e, x.Names.prefixCheck(d)[0]), x.Values.isCSSNullValue(c) && x.Hooks.templates[i] && (c = x.Hooks.templates[i][1])), l = x.Normalizations.registered[i]("extract", e, c)
                        }
                        if (!/^[\d-]/.test(l)) {
                            var p = o(e);
                            if (p && p.isSVG && x.Names.SVGAttribute(i))
                                ...
                                else l = r(e, x.Names.prefixCheck(i)[0])
                        }
                        return x.Values.isCSSNullValue(l) && (l = 0), C.debug >= 2 && console.log("Get " + i + ": " + l), l
                    },
                    setPropertyValue: function(e, i, n, s, a) {
                        ...
                        else if (x.Normalizations.registered[i] && "transform" === x.Normalizations.registered[i]("name", e)) x.Normalizations.registered[i]("inject", e, n), r = "transform", n = o(e).transformCache[i];
                        else {
                            if (x.Hooks.registered[i]) {
                                var l = i,
                                    h = x.Hooks.getRoot(i);
                                s = s || x.getPropertyValue(e, h), n = x.Hooks.injectValue(l, n, s), i = h
                            }
                            if (x.Normalizations.registered[i] && (n = x.Normalizations.registered[i]("inject", e, n), i = x.Normalizations.registered[i]("name", e)), r = x.Names.prefixCheck(i)[0], f <= 8) try {
                                e.style[r] = n
                            } catch (e) {
                    ...
                    flushTransformCache: function(e) {
                        ...
                        if ((f || C.State.isAndroid && !C.State.isChrome) && i && i.isSVG) {
                            ...
                            v.each(o(e).transformCache, function(i) {
                                return a = o(e).transformCache[i], "transformPerspective" === i ? (r = a, !0) : (9 === f && "rotateZ" === i && (i = "rotate"), void(t += i + a + " "))
                            }), r && (t = "perspective" + r + " " + t)
                        }
                        x.setPropertyValue(e, "transform", t)
                    }
                };
                x.Hooks.register(), x.Normalizations.register(), C.hook = function(e, t, i) {
                    var s;
                    return e = a(e), v.each(e, function(e, a) {
                        if (o(a) === n && C.init(a), i === n) s === n && (s = x.getPropertyValue(a, t));
                        else {
                            var r = x.setPropertyValue(a, t, i);
                            "transform" === r[0] && C.CSS.flushTransformCache(a), s = r
                        }
                    }), s
                };
                var M = function() {
                    ...
                    function s(e, s) {
                        function a(a) {
                            ...
                            if ("scroll" === S) {
                                var f, m, b, w = /^x$/i.test(l.axis) ? "Left" : "Top",
                                    M = parseFloat(l.offset) || 0;
                                l.container ? _.isWrapped(l.container) || _.isNode(l.container) ? (l.container = l.container[0] || l.container, f = l.container["scroll" + w], b = f + v(e).position()[w.toLowerCase()] + M) : l.container = null : (f = C.State.scrollAnchor[C.State["scrollProperty" + w]], m = C.State.scrollAnchor[C.State["scrollProperty" + ("Left" === w ? "Top" : "Left")]], b = v(e).offset()[w.toLowerCase()] + M), h = {
                                    scroll: {
                                        rootPropertyValue: !1,
                                        startValue: f,
                                        currentValue: f,
                                ...
                                if (!(u = o(e))) return;
                                if (!u.tweensContainer) return void v.dequeue(e, l.queue);
                                "none" === u.opts.display && (u.opts.display = "auto"), "hidden" === u.opts.visibility && (u.opts.visibility = "visible"), u.opts.loop = !1, u.opts.begin = null, u.opts.complete = null, k.easing || delete l.easing, k.duration || delete l.duration, l = v.extend({}, u.opts, l), p = v.extend(!0, {}, u ? u.tweensContainer : null);
                                for (var $ in p)
                                    if (p.hasOwnProperty($) && "element" !== $) {
                                        var B = p[$].startValue;
                                        p[$].startValue = p[$].currentValue = p[$].endValue, p[$].endValue = B, _.isEmptyObject(k) || (p[$].easing = l.easing), C.debug && console.log("reverse tweensContainer (" + $ + "): " + JSON.stringify(p[$]), e)
                                    }
                                h = p
                            } else if ("start" === S) {
                                (u = o(e)) && u.tweensContainer && !0 === u.isAnimating && (p = u.tweensContainer);
                                var D = function(s, a) {
                                    var o, d = x.Hooks.getRoot(s),
                                        c = !1,
                                        f = a[0],
                                        m = a[1],
                                        g = a[2];
                                    if (u && u.isSVG || "tween" === d || !1 !== x.Names.prefixCheck(d)[1] || x.Normalizations.registered[d] !== n) {
                                        (l.display !== n && null !== l.display && "none" !== l.display || l.visibility !== n && "hidden" !== l.visibility) && /opacity|filter/.test(s) && !g && 0 !== f && (g = 0), l._cacheValues && p && p[s] ? (g === n && (g = p[s].endValue + p[s].unitType), c = u.rootPropertyValueCache[d]) : x.Hooks.registered[s] ? g === n ? (c = x.getPropertyValue(e, d), g = x.getPropertyValue(e, s, c)) : c = x.Hooks.templates[d][1] : g === n && (g = x.getPropertyValue(e, s));
                                        var y, k, b, w = !1,
                                            E = function(e, t) {
                                                var i, n;
                                        ...
                                        if (g !== f && _.isString(g) && _.isString(f)) {
                                            ...
                                            var M = 0,
                                                ...
                                                B = 0,
                                                D = 0;
                                            for (g = x.Hooks.fixColors(g), f = x.Hooks.fixColors(f); M < g.length && T < f.length;) {
                                                var O = g[M],
                                                    A = f[T];
                                                if (/[\d\.]/.test(O) && /[\d\.]/.test(A)) {
                                                    ...
                                                    if (M += W.length, T += q.length, W === q) I === R ? o += I + W : (o += "{" + L.length + (B ? "!" : "") + "}" + W, L.push(parseFloat(I)), $.push(parseFloat(R)));
                                                    else {
                                                        var F = parseFloat(I),
                                                            N = parseFloat(R);
                                                        o += (S < 5 ? "calc" : "") + "(" + (F ? "{" + L.length + (B ? "!" : "") + "}" : "0") + W + " + " + (N ? "{" + (L.length + (F ? 1 : 0)) + (B ? "!" : "") + "}" : "0") + q + ")", F && (L.push(F), $.push(0)), N && (L.push(0), $.push(N))
                                                    }
                                                } else {
                                                    if (O !== A) {
                                                        S = 0;
                                                    ...
                                                    o += O, M++, T++, 0 === S && "c" === O || 1 === S && "a" === O || 2 === S && "l" === O || 3 === S && "c" === O || S >= 4 && "(" === O ? S++ : (S && S < 5 || S >= 4 && ")" === O && --S < 5) && (S = 0), 0 === B && "r" === O || 1 === B && "g" === O || 2 === B && "b" === O || 3 === B && "a" === O || B >= 3 && "(" === O ? (3 === B && "a" === O && (D = 1), B++) : D && "," === O ? ++D > 3 && (B = D = 0) : (D && B < (D ? 5 : 4) || B >= (D ? 4 : 3) && ")" === O && --B < (D ? 5 : 4)) && (B = D = 0)
                                                }
                                            }
                                            M === g.length && T === f.length || (C.debug && console.error('Trying to pattern match mis-matched strings ["' + f + '", "' + g + '"]'), o = n), o && (L.length ? (C.debug && console.log('Pattern found "' + o + '" -> ', L, $, "[" + g + "," + f + "]"), g = L, f = $, k = b = "") : o = n)
                                        }
                                        o || (y = E(s, g), g = y[0], b = y[1], y = E(s, f), f = y[0].replace(/^([+-\/*])=/, function(e, t) {
                                            return w = t, ""
                                        }), k = y[1], g = parseFloat(g) || 0, f = parseFloat(f) || 0, "%" === k && (/^(fontSize|lineHeight)$/.test(s) ? (f /= 100, k = "em") : /^scale/.test(s) ? (f /= 100, k = "") : /(Red|Green|Blue)$/i.test(s) && (f = f / 100 * 255, k = "")));
                                        if (/[\/*]/.test(w)) k = b;
                                        else if (b !== k && 0 !== g)
                                            if (0 === f) k = b;
                                            else {
                                                r = r || function() {
                                                    ...
                                                    P.lastParent = n.myParent, P.lastPosition = n.position, P.lastFontSize = n.fontSize;
                                                    var o = 100,
                                                        r = {};
                                                    if (a && s) r.emToPx = P.lastEmToPx, r.percentToPxWidth = P.lastPercentToPxWidth, r.percentToPxHeight = P.lastPercentToPxHeight;
                                                    else {
                                                        var l = u && u.isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                                                        C.init(l), n.myParent.appendChild(l), v.each(["overflow", "overflowX", "overflowY"], function(e, t) {
                                                            C.CSS.setPropertyValue(l, t, "hidden")
                                                        }), C.CSS.setPropertyValue(l, "position", n.position), C.CSS.setPropertyValue(l, "fontSize", n.fontSize), C.CSS.setPropertyValue(l, "boxSizing", "content-box"), v.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function(e, t) {
                                                            C.CSS.setPropertyValue(l, t, o + "%")
                                                        }), C.CSS.setPropertyValue(l, "paddingLeft", o + "em"), r.percentToPxWidth = P.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(l, "width", null, !0)) || 1) / o, r.percentToPxHeight = P.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(l, "height", null, !0)) || 1) / o, r.emToPx = P.lastEmToPx = (parseFloat(x.getPropertyValue(l, "paddingLeft")) || 1) / o, n.myParent.removeChild(l)
                                                    }
                                                    return null === P.remToPx && (P.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16), null === P.vwToPx && (P.vwToPx = parseFloat(t.innerWidth) / 100, P.vhToPx = parseFloat(t.innerHeight) / 100), r.remToPx = P.remToPx, r.vwToPx = P.vwToPx, r.vhToPx = P.vhToPx, C.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(r), e), r
                                                }();
                                        ...
                                        h[s] = {
                                            ...
                                            unitType: k,
                                            easing: m
                                        }, o && (h[s].pattern = o), C.debug && console.log("tweensContainer (" + s + "): " + JSON.stringify(h[s]), e)
                                    } else C.debug && console.log("Skipping [" + d + "] due to a lack of browser support.")
                                };
                                for (var O in y)
                                        ...
                                        if (x.Lists.colors.indexOf(A) >= 0) {
                                            ...
                                            if (x.RegEx.isHex.test(H)) {
                                                for (var q = ["Red", "Green", "Blue"], F = x.Values.hexToRgb(H), N = W ? x.Values.hexToRgb(W) : n, z = 0; z < q.length; z++) {
                                                    var j = [F[z]];
                                                    V && j.push(V), N !== n && j.push(N[z]), D(A + q[z], j)
                                                }
                                                continue
                                            }
                                        }
                            ...
                            h.element && (x.Values.addClass(e, "velocity-animating"), R.push(h), (u = o(e)) && ("" === l.queue && (u.tweensContainer = h, u.opts = l), u.isAnimating = !0), L === T - 1 ? (C.State.calls.push([R, g, l, null, E.resolver, null, 0]), !1 === C.State.isTicking && (C.State.isTicking = !0, c())) : L++)
                        }
                        var r, l = v.extend({}, C.defaults, k),
                            h = {};
                        switch (o(e) === n && C.init(e), parseFloat(l.delay) && !1 !== l.queue && v.queue(e, l.queue, function(t) {
                        ...
                        else v.queue(e, l.queue, function(e, t) {
                            return !0 === t ? (E.promise && E.resolver(g), !0) : (C.velocityQueueEntryFlag = !0, void a())
                        });
                    ...
                    _.isWrapped(this) ? (u = !1, m = 0, g = this, f = this) : (u = !0, m = 1, g = w ? arguments[0].elements || arguments[0].e : arguments[0]);
                    var E = {
                        promise: null,
                        resolver: null,
                        rejecter: null
                        ...
                        if (u && C.Promise && (E.promise = new C.Promise(function(e, t) {
                            ...
                            })), w ? (y = arguments[0].properties || arguments[0].p, k = arguments[0].options || arguments[0].o) : (y = arguments[m], k = arguments[m + 1]), g = a(g)) {
                            var T = g.length,
                                L = 0;
                            if (!/^(stop|finish|finishAll|pause|resume)$/i.test(y) && !v.isPlainObject(k)) {
                                k = {};
                                for (var $ = m + 1; $ < arguments.length; $++) _.isArray(arguments[$]) || !/^(fast|normal|slow)$/i.test(arguments[$]) && !/^\d/.test(arguments[$]) ? _.isString(arguments[$]) || _.isArray(arguments[$]) ? k.easing = arguments[$] : _.isFunction(arguments[$]) && (k.complete = arguments[$]) : k.duration = arguments[$]
                            }
                            var S;
                            switch (y) {
                                case "scroll":
                                ...
                                case "stop":
                                    v.each(g, function(e, t) {
                                        o(t) && o(t).delayTimer && (clearTimeout(o(t).delayTimer.setTimeout), o(t).delayTimer.next && o(t).delayTimer.next(), delete o(t).delayTimer), "finishAll" !== y || !0 !== k && !_.isString(k) || (v.each(v.queue(t, _.isString(k) ? k : ""), function(e, t) {
                                            _.isFunction(t) && t()
                                            ...
                                            return !0 !== a && t[2].queue !== a && (k !== n || !1 !== t[2].queue) || void v.each(g, function(i, n) {
                                                if (n === s)
                                                    if ((!0 === k || _.isString(k)) && (v.each(v.queue(n, _.isString(k) ? k : ""), function(e, t) {
                                                        ...
                                                        }), v.queue(n, _.isString(k) ? k : "", [])), "stop" === y) {
                                                        var r = o(n);
                                    ...
                                    if (!v.isPlainObject(y) || _.isEmptyObject(y)) {
                                        if (_.isString(y) && C.Redirects[y]) {
                                            var O = (h = v.extend({}, k)).duration,
                                                A = h.delay || 0;
                                            return !0 === h.backwards && (g = v.extend(!0, [], g).reverse()), v.each(g, function(e, t) {
                                                parseFloat(h.stagger) ? h.delay = A + parseFloat(h.stagger) * e : _.isFunction(h.stagger) && (h.delay = A + h.stagger.call(t, e, T)), h.drag && (h.duration = parseFloat(O) || (/^(callout|transition)/.test(y) ? 1e3 : b), h.duration = Math.max(h.duration * (h.backwards ? 1 - e / T : (e + 1) / T), .75 * h.duration, 200)), C.Redirects[y].call(t, t, h || {}, e, T, g, E.promise ? E : n)
                                            }), e()
                                        }
                                        var I = "Velocity: First argument (" + y + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                        return E.promise ? E.rejecter(new Error(I)) : console.log(I), e()
                                    }
                                    S = "start"
                            }
                            var P = {
                            ...
                            if (h.loop)
                                for (var V = 0; V < H; V++) {
                                    ...
                                    V === H - 1 && (W.display = h.display, W.visibility = h.visibility, W.complete = h.complete), M(g, "reverse", W)
                                }
                            return e()
                        }
                ...
                if (!C.State.isMobile && i.hidden !== n) {
                    ...
                    L(), i.addEventListener("visibilitychange", L)
                }
                return e.Velocity = C, e !== t && (e.fn.velocity = M, e.fn.velocity.defaults = C.defaults), v.each(["Down", "Up"], function(e, t) {
                    C.Redirects["slide" + t] = function(e, i, s, a, o, r) {
                        ...
                        l.display === n && (l.display = "Down" === t ? "inline" === C.CSS.Values.getDisplayType(e) ? "inline-block" : "block" : "none"), l.begin = function() {
                            ...
                            s === a - 1 && (u && u.call(o, o), r && r.resolver(o))
                        }, C(e, c, l)
                    }
                    ...
                    C.Redirects["fade" + t] = function(e, i, s, a, o, r) {
                        ...
                        0 !== s && (l.begin = null), l.complete = s !== a - 1 ? null : function() {
                            h && h.call(o, o), r && r.resolver(o)
...
function(e) {
    ...
    jQuery.fn[t] = function(n) {
        ...
        if ("object" == typeof n || !n) return e.init(this, arguments[0]), this;
    ...
    var n = {
        ...
        r = t.left - a,
        l = t.top - o;
    return (r < s.left + i || r < i) && (n.left = !0), (r + t.width > s.right - i || r + t.width > window.innerWidth - i) && (n.right = !0), (l < s.top + i || l < i) && (n.top = !0), (l + t.height > s.bottom - i || l + t.height > window.innerHeight - i) && (n.bottom = !0), n
    ...
    var s = {
        ...
        u = i.left - l,
        d = i.top - h;
    return s.spaceOnRight = a ? window.innerWidth - (r.left + i.width) : t.offsetWidth - (u + i.width), (!a && u + i.width > t.offsetWidth || a && r.left + i.width > window.innerWidth) && (s.left = !1), s.spaceOnLeft = a ? r.right - i.width : u - i.width + r.width, (!a && u - i.width + r.width < 0 || a && r.right - i.width < 0) && (s.right = !1), s.spaceOnBottom = a ? window.innerHeight - (r.top + i.height + n) : o.height - (d + i.height + n), (!a && d + i.height + n > o.height || a && r.top + i.height + n > window.innerHeight) && (s.top = !1), s.spaceOnTop = a ? r.bottom - (i.height + n) : d - (i.height + n), (!a && d - i.height - n < 0 || a && r.bottom - i.height - n < 0) && (s.bottom = !1), s
...
M.throttle = function(e, t, i) {
    ...
    i || (i = {});
    var l = function() {
        r = !1 === i.leading ? 0 : getTime(), o = null, a = e.apply(n, s), n = s = null
    };
    return function() {
        var h = getTime();
        r || !1 !== i.leading || (r = h);
        var u = t - (h - r);
        return n = this, s = arguments, u <= 0 ? (clearTimeout(o), o = null, r = h, a = e.apply(n, s), n = s = null) : o || !1 === i.trailing || (o = setTimeout(l, u)), a
    }
};
var Vel = void 0;
Vel = M.jQueryLoaded ? jQuery.Velocity : Velocity, M.Vel = Vel || Velocity,
    function(e, t) {
        "use strict";
        var i = {
                accordion: !0,
            ...
            n = function() {
                function n(t, i) {
                    _classCallCheck(this, n), t.M_Collapsible && t.M_Collapsible.destroy(), this.el = t, this.$el = e(t), this.el.M_Collapsible = this, this.options = e.extend({}, n.defaults, i), this._setupEventHandlers();
                ...
                return _createClass(n, [{
                    ...
                    value: function(e) {
                        ...
                        if (n.length) {
                            ...
                            t(s[0], "stop"), t(s[0], "slideDown", {
                                duration: this.options.inDuration,
                                easing: "easeInOutCubic",
                                queue: !1,
                                complete: function() {
                                    s[0].style.height = "", s[0].style.overflow = "", s[0].style.padding = "", s[0].style.margin = "", "function" == typeof i.options.onOpenEnd && i.options.onOpenEnd.call(i, n[0])
                                }
                            })
                        }
                    }
                    ...
                    value: function(e) {
                        ...
                        if (n.length) {
                            var s = n.children(".collapsible-body");
                            t(s[0], "stop"), t(s[0], "slideUp", {
                                duration: this.options.outDuration,
                                easing: "easeInOutCubic",
                                queue: !1,
                                complete: function() {
                                    s[0].style.height = "", s[0].style.overflow = "", s[0].style.padding = "", s[0].style.margin = "", "function" == typeof i.options.onCloseEnd && i.options.onCloseEnd.call(i, n[0])
                                }
                            })
                        }
                    }
        ...
        var i = {
            ...
            n = function() {
                ...
                return _createClass(n, [{
                    ...
                    value: function() {
                        document.body.addEventListener("click", this._handleDocumentClickBound, !0), this.dropdownEl.addEventListener("keydown", this._handleDropdownKeydownBound)
                    }
                }, {
                    key: "_removeTemporaryEventHandlers",
                    value: function() {
                        document.body.removeEventListener("click", this._handleDocumentClickBound, !0), this.dropdownEl.removeEventListener("keydown", this._handleDropdownKeydownBound)
                    }
                }, {
                    key: "_handleClick",
                    value: function(e) {
                    ...
                    value: function(t) {
                        ...
                        a.length && a[0].M_Dropdown && a[0].M_Dropdown.isOpen && (s = !0), s || n || this.close()
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        if (a && -1 === o.indexOf(t.which)) {
                            ...
                            l && (this.focusedIndex = e(l).index(), this._focusFocusedItem())
                        }
                    ...
                    value: function() {
                        -1 === this.dropdownEl.tabIndex && (this.dropdownEl.tabIndex = 0), e(this.dropdownEl).children().attr("tabindex", 0)
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        var e = {
                            ...
                            t = (this.dropdownEl.offsetLeft, this.dropdownEl.offsetTop, this.dropdownEl.offsetWidth, this.dropdownEl.offsetHeight, this.el.getBoundingClientRect()),
                        ...
                        if (o += this.options.coverTrigger ? 0 : t.height, h.top || (h.bottom ? u = "bottom" : h.spaceOnTop > h.spaceOnBottom ? (u = "bottom", n += h.spaceOnTop, o -= h.spaceOnTop) : n += h.spaceOnBottom), !h[d]) {
                            var c = "left" === d ? "right" : "left";
                            h[c] ? d = c : h.spaceOnLeft > h.spaceOnRight ? (d = "right", s += h.spaceOnLeft, a -= h.spaceOnLeft) : (d = "left", s += h.spaceOnRight)
                        }
                        return "bottom" === u && (o = o - i.height + (this.options.coverTrigger ? t.height : 0)), "right" === d && (a = a - i.width + t.width), {
                            x: a,
                            y: o,
                            verticalAlignment: u,
                    ...
                    value: function(e) {
                        var i = this;
                        this.dropdownEl.style.left = e.x + "px", this.dropdownEl.style.top = e.y + "px", this.dropdownEl.style.height = e.height + "px", this.dropdownEl.style.width = e.width + "px", this.dropdownEl.style.transformOrigin = ("left" === e.horizontalAlignment ? "0" : "100%") + " " + ("top" === e.verticalAlignment ? "0" : "100%"), t(this.dropdownEl, {
                            ...
                            easing: "easeOutQuint",
                            complete: function() {
                                i._focusFocusedItem(), "function" == typeof i.options.onOpenEnd && i.options.onOpenEnd.call(i, i.el)
                            }
                        })
                    }
                }, {
                    ...
                    value: function() {
                        if (!this.isOpen) {
                            this.isOpen = !0, null === this.focusedIndex && (this.focusedIndex = 0), "function" == typeof this.options.onOpenStart && this.options.onOpenStart.call(this, this.el), t(this.dropdownEl, "stop"), this._resetDropdownStyles(), t.hook(this.dropdownEl, "display", "block");
                            ...
                            this._animateIn(i), this._setupTemporaryEventHandlers()
                        }
                    }
                }, {
                    key: "close",
                    value: function() {
                        this.isOpen && (this.isOpen = !1, "function" == typeof this.options.onCloseStart && this.options.onCloseStart.call(this, this.el), this._animateOut(), this._removeTemporaryEventHandlers(), this.el.focus())
                    }
                }], [{
                    key: "init",
                    value: function(e, t) {
    ...
    function(e, t) {
                ...
                return _createClass(n, [{
                    ...
                    value: function() {
                        ...
                        this.el.classList.contains("bottom-sheet") ? t(this.el, {
                            bottom: 0,
                            opacity: 1
                        }, n) : (t.hook(this.el, "scaleX", .8), t.hook(this.el, "scaleY", .8), this.el.style.top = this.options.startingTop, t(this.el, {
                    ...
                    value: function() {
                        ...
                        var i = {
                            ...
                            ease: "easeOutCubic",
                            complete: function() {
                                e.el.style.display = "none", "function" == typeof e.options.complete && e.options.complete.call(e, e.$el), e.$overlay.remove()
                            }
                        };
                        this.el.classList.contains("bottom-sheet") ? t(this.el, {
                            bottom: "-100%",
                    ...
                    value: function(e) {
                        if (!this.isOpen) {
                            this.isOpen = !0;
                            var t = document.body;
                            return t.style.overflow = "hidden", this.el.classList.add("open"), t.appendChild(this.$overlay[0]), this._openingTrigger = e || void 0, this.options.dismissible && (this._handleKeydownBound = this._handleKeydown.bind(this), document.addEventListener("keydown", this._handleKeydownBound)), this._animateIn(), this
                        }
                    }
                }, {
                    key: "close",
                    value: function() {
                        if (this.isOpen) return this.isOpen = !1, this.el.classList.remove("open"), document.body.style.overflow = "", this.options.dismissible && document.removeEventListener("keydown", this._handleKeydownBound), this._animateOut(), this
                    }
                }], [{
                    key: "init",
                    value: function(e, t) {
        ...
        n._increment = 0, n._count = 0, M.Modal = n, M.jQueryLoaded && M.initializeJqueryWrapper(n, "modal", "M_Modal")
    }(cash, M.Vel),
    function(e, t) {
        "use strict";
        var i = {
            ...
            n = function() {
                ...
                return _createClass(n, [{
                    ...
                    value: function() {
                        ...
                        this.$el.hasClass("responsive-img") ? (n.maxWidth = [this.newWidth, this.newWidth], n.width = [n.width, this.originalWidth]) : (n.left = [n.left, 0], n.top = [n.top, 0]), t(this.el, n, i)
                    }
                }, {
                            ...
                            i = {
                                ...
                                complete: function() {
                                    e.placeholder.css({
                                        ...
                                        top: "",
                                        left: ""
                                    }), e.$el.removeAttr("style"), e.$el.attr("style", e.originInlineStyles), e.$el.removeClass("active"), e.doneAnimating = !0, e.ancestorsChanged.length && e.ancestorsChanged.css("overflow", "")
                                }
                            };
                        t(this.el, {
                    ...
                    value: function() {
                        var i = this;
                        this._updateVars(), this.originalWidth = this.el.getBoundingClientRect().width, this.originalHeight = this.el.getBoundingClientRect().height, this.doneAnimating = !1, this.$el.addClass("active"), this.overlayActive = !0, this.placeholder.css({
                        ...
                        this.$overlay.css({
                            ...
                            queue: !1,
                            ease: "easeOutQuad"
                        }), "" !== this.caption && (this.$photoCaption = e('<div class="materialbox-caption"></div>'), this.$photoCaption.text(this.caption), e("body").append(this.$photoCaption), this.$photoCaption.css({
                            display: "inline"
                    ...
                    value: function() {
                        ...
                        }), this._animateImageOut(), "" !== this.caption && t(this.$photoCaption[0], {
                            opacity: 0
                        }, {
                            duration: this.options.outDuration,
                            queue: !1,
    ...
    function(e) {
        ...
        var t = {},
            i = function() {
                function i(t, n) {
                    _classCallCheck(this, i), t.M_Parallax && t.M_Parallax.destroy(), this.el = t, this.$el = e(t), this.el.M_Parallax = this, this.options = e.extend({}, i.defaults, n), this.$img = this.$el.find("img").first(), this._updateParallax(), this._setupEventHandlers(), this._setupStyles(), i._parallaxes.push(this)
                }
                return _createClass(i, [{
                    ...
                    key: "_setupEventHandlers",
                    value: function() {
                        this._handleImageLoadBound = this._handleImageLoad.bind(this), this.$img[0].addEventListener("load", this._handleImageLoadBound), 0 === i._parallaxes.length && (i._handleScrollThrottled = M.throttle(i._handleScroll, 5), window.addEventListener("scroll", i._handleScrollThrottled))
                    }
                }, {
                    key: "_setupStyles",
                    value: function() {
                    ...
                    value: function() {
                        this._updateParallax(), this.$img.each(function() {
                            var t = this;
                ...
                return _createClass(n, [{
                    ...
                    value: function(t) {
                        ...
                        if (s.length && s.parent().hasClass("tab"))
                            ...
                            }) : void 0 !== this.$content && (this.$content[0].style.display = "block", this.$content.addClass("active"), "function" == typeof this.options.onShow && this.options.onShow.call(this, this.$content[0]), void 0 === a || a.is(this.$content) || (a[0].style.display = "none", a.removeClass("active"))), this._animateIndicator(o), t.preventDefault()
                        }
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        i.first().before(n), n.append(i), i[0].style.display = "", this._tabsCarousel = new M.Carousel(n[0], {
                            fullWidth: !0,
                            noWrap: !0,
                            onCycleTo: function(i) {
                                var n = t.index;
                                t.index = e(i).index(), t.$activeTabLink.removeClass("active"), t.$activeTabLink = t.$tabLinks.eq(t.index), t.$activeTabLink.addClass("active"), t._animateIndicator(n), "function" == typeof t.options.onShow && t.options.onShow.call(t, t.$content)
                            }
                        })
                    }
                }, {
    ...
    function(e, t) {
        ...
        var i = {
            ...
            n = function() {
                function n(t, i) {
                    _classCallCheck(this, n), t.M_Tooltip && t.M_Tooltip.destroy(), this.el = t, this.$el = e(t), this.el.M_Tooltip = this, this.options = e.extend({}, n.defaults, i), this.isOpen = !1, this.isHovered = !1, this._appendTooltipEl(), this._setupEventHandlers()
                }
                return _createClass(n, [{
                    key: "destroy",
                    value: function() {
                        e(this.tooltipEl).remove(), this._removeEventHandlers(), this.$el[0].M_Tooltip = void 0
                    }
                }, {
                    ...
                    key: "open",
                    value: function() {
                        this.isOpen || (this.isOpen = !0, this.options = e.extend({}, this.options, this._getAttributeOptions()), this._updateTooltipContent(), this._setEnterDelayTimeout())
                    }
                }, {
                    key: "close",
                    value: function() {
                    ...
                    value: function(e, t, i, n) {
                        ...
                        return u.left ? o = h : u.right && (o -= o + i - window.innerWidth), u.top ? r = h : u.bottom && (r -= r + n - window.innerHeight), {
                            x: o + s,
                            y: r + a
                        }
                    }
                    ...
                    key: "_animateIn",
                    value: function() {
                        this._positionTooltip(), this.tooltipEl.style.visibility = "visible", t(this.tooltipEl, "stop"), t(this.tooltipEl, {
                            opacity: 1,
                    ...
                    key: "_animateOut",
                    value: function() {
                        t(this.tooltipEl, "stop"), t(this.tooltipEl, {
                            opacity: 0,
                            translateX: 0,
                            translateY: 0
                        }, {
    ...
    function(e) {
        ...
        function n(e) {
            var t, n, s = {
                ...
                a = e && e.ownerDocument;
            return t = a.documentElement, void 0 !== e.getBoundingClientRect && (s = e.getBoundingClientRect()), n = i(a), {
        ...
        function o(t) {
            var i = a(t);
            null !== i && (h.show(t, i), "ontouchstart" in e && (i.addEventListener("touchend", h.hide, !1), i.addEventListener("touchcancel", h.hide, !1)), i.addEventListener("mouseup", h.hide, !1), i.addEventListener("mouseleave", h.hide, !1), i.addEventListener("dragend", h.hide, !1))
        }
        var r = r || {},
            ...
            h = {
                ...
                show: function(e, t) {
                    ...
                    "touches" in e && (r = e.touches[0].pageY - o.top, l = e.touches[0].pageX - o.left), a.setAttribute("data-hold", Date.now()), a.setAttribute("data-scale", u), a.setAttribute("data-x", l), a.setAttribute("data-y", r);
                    var d = {
                        top: r + "px",
                        left: l + "px"
                    };
                    a.className = a.className + " waves-notransition", a.setAttribute("style", s(d)), a.className = a.className.replace("waves-notransition", ""), d["-webkit-transform"] = u, d["-moz-transform"] = u, d["-ms-transform"] = u, d["-o-transform"] = u, d.transform = u, d.opacity = "1", d["-webkit-transition-duration"] = h.duration + "ms", d["-moz-transition-duration"] = h.duration + "ms", d["-o-transition-duration"] = h.duration + "ms", d["transition-duration"] = h.duration + "ms", d["-webkit-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", d["-moz-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", d["-o-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", d["transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", a.setAttribute("style", s(d))
                },
                hide: function(e) {
                    u.touchup(e);
                    var t = this,
        ...
        r.displayEffect = function(t) {
            "duration" in (t = t || {}) && (h.duration = t.duration), h.wrapInput(l(".waves-effect")), "ontouchstart" in e && document.body.addEventListener("touchstart", o, !1), document.body.addEventListener("mousedown", o, !1)
        }, r.attach = function(t) {
            "input" === t.tagName.toLowerCase() && (h.wrapInput([t]), t = t.parentNode), "ontouchstart" in e && t.addEventListener("touchstart", o, !1), t.addEventListener("mousedown", o, !1)
        }, e.Waves = r, document.addEventListener("DOMContentLoaded", function() {
            r.displayEffect()
        }, !1)
    }(window),
    function(e, t) {
        ...
        var i = {
            ...
            n = function() {
                function n(t) {
                    _classCallCheck(this, n), this.options = e.extend({}, n.defaults, t), this.message = this.options.html, this.panning = !1, this.timeRemaining = this.options.displayLength, 0 === n._toasts.length && n._createContainer(), n._toasts.push(this);
                ...
                return _createClass(n, [{
                    ...
                    value: function() {
                        if (n._draggedToast) {
                            ...
                            Math.abs(t) > i || e.velocityX > 1 ? (e.wasSwiped = !0, e.dismiss()) : (e.el.style.transition = "transform .2s, opacity .2s", e.el.style.transform = "", e.el.style.opacity = ""), n._draggedToast = null
                        }
                    }
                }, {
                    key: "_xPos",
    ...
    function(e, t) {
        ...
        var i = {
            ...
            n = function() {
                function n(t, i) {
                    _classCallCheck(this, n), t.M_Sidenav && t.M_Sidenav.destroy(), this.el = t, this.$el = e(t), this.el.M_Sidenav = this, this.id = this.$el.attr("id"), this.options = e.extend({}, n.defaults, i), this.isOpen = !1, this.isFixed = this.el.classList.contains("sidenav-fixed"), this.isDragged = !1, this._createOverlay(), this._createDragTarget(), this._setupEventHandlers(), this._setupClasses(), this._setupFixed(), n._sidenavs.push(this)
                }
                return _createClass(n, [{
                    key: "destroy",
                    value: function() {
                    ...
                    value: function(e) {
                        ...
                        this.isDragged = !0, this._startingXpos = i, this._xPos = this._startingXpos, this._time = Date.now(), this._width = this.el.getBoundingClientRect().width, this._overlay.style.display = "block", t(this.el, "stop"), t(this._overlay, "stop")
                    }
                }, {
                    key: "_dragMoveUpdate",
                    value: function(e) {
                        var t = e.targetTouches[0].clientX;
                        this.deltaX = Math.abs(this._xPos - t), this._xPos = t, this.velocityX = this.deltaX / (Date.now() - this._time), this._time = Date.now()
                    }
                }, {
                    ...
                    key: "open",
                    value: function() {
                        !0 !== this.isOpen && (this.isOpen = !0, "function" == typeof this.options.onOpenStart && this.options.onOpenStart.call(this, this.el), this.isFixed && window.innerWidth > 992 ? (t(this.el, "stop"), t(this.el, {
                            translateX: 0
                        }, {
                            duration: 0,
                            queue: !1
                    ...
                    value: function() {
                        if (!1 !== this.isOpen)
                            if (this.isOpen = !1, "function" == typeof this.options.onCloseStart && this.options.onCloseStart.call(this, this.el), this.isFixed && window.innerWidth > 992) {
                    ...
                    value: function() {
                        ...
                        this.isDragged && (i = "left" === this.options.edge ? i + this.percentOpen : i - this.percentOpen), t(this.el, "stop"), t(this.el, {
                            translateX: [0, 100 * i + "%"]
                        }, {
                            duration: this.options.inDuration,
                            queue: !1,
                    ...
                    value: function() {
                        var e = 0;
                        this.isDragged ? e = this.percentOpen : t.hook(this._overlay, "display", "block"), t(this._overlay, "stop"), t(this._overlay, {
                            opacity: [1, e]
                        }, {
                            duration: this.options.inDuration,
                            queue: !1,
                    ...
                    value: function() {
                        var e = this,
                            i = "left" === this.options.edge ? -1 : 1,
                            n = 0;
                        this.isDragged && (n = "left" === this.options.edge ? i + this.percentOpen : i - this.percentOpen), t(this.el, "stop"), t(this.el, {
                    ...
                    value: function() {
                        t(this._overlay, "stop"), t(this._overlay, "fadeOut", {
                            duration: this.options.outDuration,
                            queue: !1,
                            easing: "easeOutQuad"
                        })
    ...
    function(e, t) {
        ...
        var i = {
            ...
            n = function() {
                function n(t, i) {
                    _classCallCheck(this, n), t.M_ScrollSpy && t.M_ScrollSpy.destroy(), this.el = t, this.$el = e(t), this.el.M_ScrollSpy = this, this.options = e.extend({}, n.defaults, i), n._elements.push(this), n._count++, n._increment++, this.tickId = -1, this.id = n._increment, this._setupEventHandlers(), this._handleWindowScroll()
                }
                return _createClass(n, [{
                    key: "destroy",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        for (var e = M.getDocumentScrollTop(), t = M.getDocumentScrollLeft(), i = t + window.innerWidth, s = e + window.innerHeight, a = n._findElements(e, i, s, t), o = 0; o < a.length; o++) {
                            var r = a[o];
                            r.tickId < 0 && r._enter(), r.tickId = n._ticks
                        }
                        for (var l = 0; l < n._elementsInView.length; l++) {
                            var h = n._elementsInView[l],
                                u = h.tickId;
                            u >= 0 && u !== n._ticks && (h._exit(), h.tickId = -1)
                        }
                        n._elementsInView = a
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        n._visibleElements = n._visibleElements.filter(function(e) {
                            return 0 != e.height()
                        }), n._visibleElements[0] && (e(this.options.getActiveElement(n._visibleElements[0].attr("id"))).removeClass(this.options.activeClass), n._visibleElements = n._visibleElements.filter(function(e) {
        ...
        var t = {
            ...
            i = function() {
                ...
                return _createClass(i, [{
                    ...
                    key: "_setupDropdown",
                    value: function() {
                        this.container = document.createElement("ul"), e(this.container).addClass("autocomplete-content dropdown-content"), this.$inputField.append(this.container)
                    }
                }, {
                    key: "_removeDropdown",
                    value: function() {
                    ...
                    value: function(e) {
                        ...
                        13 !== e.keyCode && 38 !== e.keyCode && 40 !== e.keyCode && (this.oldVal !== t && (this._removeAutocomplete(), t.length >= this.options.minLength && (this.isOpen = !0, this._renderDropdown(this.options.data, t))), this.oldVal = t)
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        13 === n && this.activeIndex >= 0 ? (s = e(this.container).children("li").eq(this.activeIndex)).length && (this.selectOption(s), t.preventDefault()) : 38 !== n && 40 !== n || (t.preventDefault(), 38 === n && this.activeIndex > 0 && this.activeIndex--, 40 === n && this.activeIndex < a - 1 && this.activeIndex++, this.$active.removeClass("active"), this.activeIndex >= 0 && (this.$active = e(this.container).children("li").eq(this.activeIndex), this.$active.addClass("active")))
                    }
                }, {
                    ...
                    value: function(e) {
                        var t = e.text().trim();
                        this.el.value = t, this.$el.trigger("change"), this._removeAutocomplete(), "function" == typeof this.options.onAutocomplete && this.options.onAutocomplete.call(this, t)
                    }
                }, {
                    key: "_renderDropdown",
                    value: function(t, i) {
                        ...
                        for (var r = 0; r < s.length; r++) {
                            var l = s[r],
                                h = e("<li></li>");
                            l.data ? h.append('<img src="' + l.data + '" class="right circle"><span>' + l.key + "</span>") : h.append("<span>" + l.key + "</span>"), e(this.container).append(h), this._highlight(i, h)
                        }
                    }
                }, {
                    key: "updateData",
    ...
    function(e) {
        M.updateTextFields = function() {
            ...
            var n = t.css("font-family"),
                ...
                a = t.css("line-height"),
                o = t.css("padding");
            s && i.css("font-size", s), n && i.css("font-family", n), a && i.css("line-height", a), o && i.css("padding", o), t.data("original-height") || t.data("original-height", t.height()), "off" === t.attr("wrap") && i.css("overflow-wrap", "normal").css("white-space", "pre"), i.text(t[0].value + "\n");
            var r = i.html().replace(/\n/g, "<br>");
            i.html(r), "hidden" !== t.css("display") ? i.css("width", t.width() + "px") : i.css("width", e(window).width() / 2 + "px"), t.data("original-height") <= i.innerHeight() ? t.css("height", i.innerHeight() + "px") : t[0].value.length < t.data("previous-length") && t.css("height", t.data("original-height") + "px"), t.data("previous-length", t[0].value.length)
            ...
            e(".materialize-textarea").each(function() {
                ...
                for (var t = e(this).closest(".file-field").find("input.file-path"), i = e(this)[0].files, n = [], s = 0; s < i.length; s++) n.push(i[s].name);
    ...
    function(e, t) {
        ...
        var i = {
            ...
            n = function() {
                function n(i, s) {
                    var a = this;
                    _classCallCheck(this, n), i.M_Slider && i.M_Slider.destroy(), this.el = i, this.$el = e(i), this.el.M_Slider = this, this.options = e.extend({}, n.defaults, s), this.$slider = this.$el.find(".slides"), this.$slides = this.$slider.children("li"), this.activeIndex = this.$slider.find(".active").index(), -1 != this.activeIndex && (this.$active = this.$slides.eq(this.activeIndex)), this._setSliderHeight(), this.$slides.find(".caption").each(function(e) {
                    ...
                    }), this._setupIndicators(), this.$active ? this.$active.css("display", "block") : (this.$slides.first().addClass("active"), t(this.$slides.first()[0], {
                        opacity: 1
                    }, {
                        duration: this.options.duration,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), this.activeIndex = 0, this.$active = this.$slides.eq(this.activeIndex), this.options.indicators && this.$indicators.eq(this.activeIndex).addClass("active")), this.$active.find("img").each(function(e) {
                ...
                return _createClass(n, [{
                    ...
                    value: function(i, n) {
                        ...
                        e(i).hasClass("center-align") ? s.translateY = -100 : e(i).hasClass("right-align") ? s.translateX = 100 : e(i).hasClass("left-align") && (s.translateX = -100), t(i, s, {
                            duration: n,
                            queue: !1
                        })
                    }
                    ...
                    value: function(e) {
                        ...
                        if (e >= this.$slides.length ? e = 0 : e < 0 && (e = this.$slides.length - 1), this.activeIndex != e) {
                            ...
                            this.$active.removeClass("active"), t(this.$active[0], {
                                opacity: 0
                            }, {
                                duration: this.options.duration,
                                queue: !1,
                            ...
                            }), this._animateCaptionIn(n[0], this.options.duration), this.options.indicators && (this.$indicators.eq(this.activeIndex).removeClass("active"), this.$indicators.eq(e).addClass("active")), t(this.$slides.eq(e)[0], {
                                opacity: 1
                            }, {
                                duration: this.options.duration,
                                queue: !1,
    ...
    function(e, t) {
        e(document).on("click", ".card", function(i) {
            if (e(this).children(".card-reveal").length) {
                ...
                }) : (e(i.target).is(e(".card .activator")) || e(i.target).is(e(".card .activator i"))) && (n.css("overflow", "hidden"), s.css({
                    display: "block"
                }), t(s, "stop"), t(s, {
                    translateY: "-100%"
                }, {
    ...
    function(e, t) {
        ...
        var i = {
            ...
            n = function() {
                function t(i, n) {
                    _classCallCheck(this, t), i.M_Chips && i.M_Chips.destroy(), this.el = i, this.$el = e(i), this.el.M_Chips = this, this.options = e.extend({}, t.defaults, n), this.$el.addClass("chips input-field"), this.chipsData = [], this.$chips = e(), this.$input = this.$el.find("input"), this.$input.addClass("input"), this.hasAutocomplete = Object.keys(this.options.autocompleteOptions).length > 0, this.$input.attr("id") || this.$input.attr("id", M.guid()), this.options.data.length && (this.chipsData = this.options.data, this._renderChips(this.chipsData)), this.hasAutocomplete && this._setupAutocomplete(), this._setPlaceholder(), this._setupLabel(), this._setupEventHandlers()
                }
                return _createClass(t, [{
                    ...
                    value: function(t) {
                        this.$chips.eq(t).remove(), this.$chips = this.$chips.filter(function(t) {
                            return e(t).index() >= 0
                        }), this.chipsData.splice(t, 1), this._setPlaceholder(), "function" == typeof this.options.onChipDelete && this.options.onChipDelete.call(this, this.$el, this.$chip)
                    }
                }, {
                    key: "selectChip",
                    value: function(e) {
                        var t = this.$chips.eq(e);
                        this._selectedChip = t, t[0].focus(), "function" == typeof this.options.onChipSelect && this.options.onChipSelect.call(this, this.$el, this.$chip)
                    }
                }, {
                    key: "deselectChip",
                    value: function(e) {
                        ...
                        if (!e(i.target).is("input, textarea") && s) {
                            ...
                            if (8 === i.keyCode || 46 === i.keyCode) {
                                ...
                                if (a._selectedChip) {
                                    ...
                                    a.deleteChip(r), a._selectedChip = null, o = r - 1
                                }
        ...
        n._keydown = !1, M.Chips = n, M.jQueryLoaded && M.initializeJqueryWrapper(n, "chips", "M_Chips"), e(document).ready(function() {
    ...
    function(e) {
        ...
        var t = {
            ...
            i = function() {
                function i(t, n) {
                    _classCallCheck(this, i), t.M_Pushpin && t.M_Pushpin.destroy(), this.el = t, this.$el = e(t), this.el.M_Pushpin = this, this.options = e.extend({}, i.defaults, n), this.originalOffset = this.el.offsetTop, i._pushpins.push(this), this._setupEventHandlers(), this._updatePosition()
                }
                return _createClass(i, [{
                    key: "destroy",
                    value: function() {
    ...
    function(e, t) {
        ...
        var n = function() {
            ...
            return _createClass(n, [{
                ...
                key: "_animateInFAB",
                value: function() {
                    this.$el.addClass("active"), t.hook(this.$floatingBtns, "scaleX", .4), t.hook(this.$floatingBtns, "scaleY", .4), t.hook(this.$floatingBtns, "translateY", this.offsetY + "px"), t.hook(this.$floatingBtns, "translateX", this.offsetX + "px");
                    var e = 0;
                ...
                key: "_animateOutFAB",
                value: function() {
                    this.$el.removeClass("active"), t(this.$floatingBtns, "stop"), t(this.$floatingBtns, {
                        opacity: "0",
                        scaleX: .4,
                        scaleY: .4,
                ...
                value: function() {
                    ...
                    this.$anchor.append(o), this.offsetX = a.left - n / 2 + a.width / 2, this.offsetY = s - a.bottom, i = n / o[0].clientWidth, this.btnBottom = a.bottom, this.btnLeft = a.left, this.btnWidth = a.width, this.$el.addClass("active"), this.$el.css({
                        "text-align": "center",
                        width: "100%",
                        bottom: 0,
                        left: 0,
        ...
        var i = {
            ...
            n = function() {
                ...
                return _createClass(t, [{
                    ...
                    value: function() {
                        var e = this;
                        this.modalEl.id = "modal-" + this.id, this.modal = new M.Modal(this.modalEl, {
                            complete: function() {
                                e.isOpen = !1
                            }
                        })
                    ...
                    key: "toString",
                    value: function(e) {
                        return e = e || this.options.format, t._isDate(this.date) ? this.options.toString ? this.options.toString(this.date, e) : this.date.toDateString() : ""
                    }
                }, {
                    key: "setDate",
                    value: function(e, i) {
                        if (!e) return this.date = null, this._renderDateDisplay(), this.draw();
                        if ("string" == typeof e && (e = new Date(Date.parse(e))), t._isDate(e)) {
                            var n = this.options.minDate,
                                s = this.options.maxDate;
                            t._isDate(n) && e < n ? e = n : t._isDate(s) && e > s && (e = s), this.date = new Date(e.getTime()), this._renderDateDisplay(), t._setToStartOfDay(this.date), this.gotoDate(this.date), i || "function" != typeof this.options.onSelect || this.options.onSelect.call(this, this.getDate())
                        }
                    }
                }, {
                    key: "setInputValue",
                    ...
                    value: function() {
                        var e = t._isDate(this.date) ? this.date : new Date,
                            ...
                            a = e.getDate();
                        this.yearTextEl.innerHTML = e.getFullYear(), this.dateTextEl.innerHTML = n + ", " + s + " " + a
                    }
                }, {
                    key: "gotoDate",
                    value: function(e) {
                        ...
                        if (t._isDate(e)) {
                            if (this.calendars) {
                                var n = new Date(this.calendars[0].year, this.calendars[0].month, 1),
                                    ...
                                    a = e.getTime();
                                s.setMonth(s.getMonth() + 1), s.setDate(s.getDate() - 1), i = a < n.getTime() || s.getTime() < a
                            }
                            i && (this.calendars = [{
                                month: e.getMonth(),
                                year: e.getFullYear()
                    ...
                    value: function(e, i, n) {
                        var s = this.options,
                            ...
                            l = [],
                            h = [];
                        t._setToStartOfDay(a), s.firstDay > 0 && (r -= s.firstDay) < 0 && (r += 7);
                        for (var u = 0 === i ? 11 : i - 1, d = 11 === i ? 0 : i + 1, c = 0 === i ? e - 1 : e, p = 11 === i ? e + 1 : e, v = t._getDaysInMonth(c, u), f = o + r, m = f; m > 7;) m -= 7;
                        f += 7 - m;
                        for (var g = !1, y = 0, _ = 0; y < f; y++) {
                            ...
                            E && (y < r ? (x = v + x, M = u, T = c) : (x -= o, M = d, T = p));
                            var D = {
                                day: x,
                                month: M,
                                year: T,
                            ...
                            h.push(this.renderDay(D)), 7 == ++_ && (l.push(this.renderRow(h, s.isRTL, g)), h = [], _ = 0, g = !1)
                        }
                    ...
                    value: function(t, i, n, s, a, o) {
                        var r = void 0,
                            ...
                            m = !0,
                            g = !0;
                        for (h = [], r = 0; r < 12; r++) h.push('<option value="' + (n === a ? r - i : 12 + r - i) + '"' + (r === s ? ' selected="selected"' : "") + (d && r < u.minMonth || c && r > u.maxMonth ? 'disabled="disabled"' : "") + ">" + u.i18n.months[r] + "</option>");
                        for (v = '<select class="pika-select pika-select-month" tabindex="-1">' + h.join("") + "</select>", e.isArray(u.yearRange) ? (r = u.yearRange[0], l = u.yearRange[1] + 1) : (r = n - u.yearRange, l = 1 + n + u.yearRange), h = []; r < l && r <= u.maxYear; r++) r >= u.minYear && h.push('<option value="' + r + '"' + (r === n ? ' selected="selected"' : "") + ">" + r + "</option>");
                        f = '<select class="pika-select pika-select-year" tabindex="-1">' + h.join("") + "</select>";
                        p += '<button class="month-prev' + (m ? "" : " is-disabled") + '" type="button"><svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"/><path d="M0-.5h24v24H0z" fill="none"/></svg></button>', p += '<div class="selects-container">', u.showMonthAfterYear ? p += f + v : p += v + f, p += "</div>", d && (0 === s || u.minMonth >= s) && (m = !1), c && (11 === s || u.maxMonth <= s) && (g = !1);
                    ...
                    value: function(e) {
                        if (this.isOpen || e) {
                            var t = this.options,
                                ...
                                o = "",
                                r = void 0;
                            this._y <= i && (this._y = i, !isNaN(s) && this._m < s && (this._m = s)), this._y >= n && (this._y = n, !isNaN(a) && this._m > a && (this._m = a)), r = "pika-title-" + Math.random().toString(36).replace(/[^a-z]+/g, "").substr(0, 2);
                            for (var l = 0; l < 1; l++) this._renderDateDisplay(), o += this.renderTitle(this, l, this.calendars[l].year, this.calendars[l].month, this.calendars[0].year, r) + this.render(this.calendars[l].year, this.calendars[l].month, r);
                            this.calendarEl.innerHTML = o, new M.Select(this.calendarEl.querySelector(".pika-select-year"), {
                                classes: "select-year"
                    ...
                    key: "_setupVariables",
                    value: function() {
                        this.$modalEl = e(t._template), this.modalEl = this.$modalEl[0], this.calendarEl = this.modalEl.querySelector(".pika-single"), this.yearTextEl = this.modalEl.querySelector(".year-text"), this.dateTextEl = this.modalEl.querySelector(".date-text"), this.clearBtn = this.modalEl.querySelector(".datepicker-clear"), this.todayBtn = this.modalEl.querySelector(".datepicker-today"), this.doneBtn = this.modalEl.querySelector(".datepicker-done")
                    }
                }, {
                    key: "_removeEventHandlers",
                    value: function() {
                    ...
                    value: function(e) {
                        var i = void 0;
                        e.firedBy !== this && (i = this.options.parse ? this.options.parse(this.el.value, this.options.format) : new Date(Date.parse(this.el.value)), t._isDate(i) && this.setDate(i))
                    }
                }, {
                    key: "renderDayName",
                    value: function(e, t, i) {
    ...
    function(e, t) {
        ...
        var i = {
            ...
            n = function() {
                function t(i, n) {
                    _classCallCheck(this, t), i.M_Timepicker && i.M_Timepicker.destroy(), this.el = i, this.$el = e(i), this.el.M_Timepicker = this, this.options = e.extend({}, t.defaults, n), this.id = M.guid(), this._insertHTMLIntoDOM(), this._setupModal(), this._setupVariables(), this._setupEventHandlers(), this._clockSetup(), this._pickerSetup()
                }
                return _createClass(t, [{
                    key: "destroy",
                    value: function() {
                    ...
                    value: function(e) {
                        ...
                        var i = t._Pos(e),
                            n = i.x - this.x0,
                            s = i.y - this.y0;
                        this.moved && n === this.dx && s === this.dy && this.setHand(n, s), "hours" === this.currentView ? this.showView("minutes", this.options.duration / 2) : this.options.autoClose && (this.minutesView.addClass("timepicker-dial-out"), setTimeout(function() {
                            this.done()
                    ...
                    key: "_insertHTMLIntoDOM",
                    value: function() {
                        this.$modalEl = e(t._template), this.modalEl = this.$modalEl[0], this.modalEl.id = "modal-" + this.id;
                    ...
                    value: function() {
                        ...
                        e('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.cancelText + "</button>").appendTo(t).on("click", this.close.bind(this)), e('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.doneText + "</button>").appendTo(t).on("click", this.done.bind(this)), t.appendTo(this.footer)
                    }
                }, {
                    key: "_clockSetup",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        l.setAttribute("class", "timepicker-canvas-bg"), l.setAttribute("r", i), a.appendChild(r), a.appendChild(l), a.appendChild(o), s.appendChild(a), this._canvas.appendChild(s), this.hand = r, this.bg = l, this.bearing = o, this.g = a
                    }
                }, {
                    key: "_buildHoursView",
                    value: function() {
                        ...
                        if (this.options.twelveHour)
                            for (var i = 1; i < 13; i += 1) {
                                ...
                                for (var o = 0; o < 24; o += 1) {
                                    ...
                                    }), r.html(0 === o ? "00" : o), this.hoursView.appendChild(r[0])
                                }
                    }
                }, {
                    ...
                    value: function() {
                        for (var i = e('<div class="timepicker-tick"></div>'), n = 0; n < 60; n += 5) {
                            ...
                            }), s.html(t._addLeadingZero(n)), this.minutesView.appendChild(s[0])
                        }
                    }
                }, {
                    ...
                    key: "_updateAmPmView",
                    value: function() {
                        this.$amBtn.toggleClass("text-primary", "AM" === this.amOrPm), this.$pmBtn.toggleClass("text-primary", "PM" === this.amOrPm)
                    }
                }, {
                    key: "_updateTimeFromInput",
                    value: function() {
                        var e = ((this.el.value || this.options.defaultTime || "") + "").split(":");
                        if (this.options.twelveHour && void 0 !== e[1] && (e[1].indexOf("AM") > 0 ? this.amOrPm = "AM" : this.amOrPm = "PM", e[1] = e[1].replace("AM", "").replace("PM", "")), "now" === e[0]) {
                        ...
                        this.hours = +e[0] || 0, this.minutes = +e[1] || 0, this.spanHours.innerHTML = this.hours, this.spanMinutes.innerHTML = t._addLeadingZero(this.minutes), this._updateAmPmView()
                    }
                }, {
                    key: "showView",
                    value: function(t, i) {
                        ...
                        this.currentView = t, e(this.spanHours).toggleClass("text-primary", n), e(this.spanMinutes).toggleClass("text-primary", !n), a.classList.add("timepicker-dial-out"), e(s).css("visibility", "visible").removeClass("timepicker-dial-out"), this.resetClock(i), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function() {
                    ...
                    value: function(t) {
                        ...
                        t ? (e(this.canvas).addClass("timepicker-canvas-out"), setTimeout(function() {
                            e(h.canvas).removeClass("timepicker-canvas-out"), h.setHand(r, l)
                        }, t)) : this.setHand(r, l)
                    }
                }, {
                    key: "setHand",
                    value: function(e, i, n) {
                        ...
                        this.options.twelveHour && (u = this.options.outerRadius), a < 0 && (a = 2 * Math.PI + a);
                        var d = Math.round(a / r);
                        a = d * r, this.options.twelveHour ? o ? 0 === d && (d = 12) : (n && (d *= 5), 60 === d && (d = 0)) : o ? (12 === d && (d = 0), d = h ? 0 === d ? 12 : d : 0 === d ? 0 : d + 12) : (n && (d *= 5), 60 === d && (d = 0)), this[this.currentView] !== d && this.vibrate && this.options.vibrate && (this.vibrateTimer || (navigator[this.vibrate](10), this.vibrateTimer = setTimeout(function() {
                            s.vibrateTimer = null
                        }, 100))), this[this.currentView] = d, o ? this.spanHours.innerHTML = d : this.spanMinutes.innerHTML = t._addLeadingZero(d);
                    ...
                    value: function(e, i) {
                        ...
                        this.time = s, !i && this.options.twelveHour && (s = s + " " + this.amOrPm), this.el.value = s, s !== n && this.$el.trigger("change"), this.close(), this.el.focus()
                    }
                }, {
                    key: "clear",
                    value: function() {
    ...
    function(e) {
        ...
        var t = {},
            i = function() {
                function i(t, n) {
                    _classCallCheck(this, i), t.M_CharacterCounter && t.M_CharacterCounter.destroy(), this.el = t, this.$el = e(t), this.el.M_CharacterCounter = this, this.options = e.extend({}, i.defaults, n), this.isInvalid = !1, this.isValidLength = !1, this._setupCounter(), this._setupEventHandlers()
                }
                return _createClass(i, [{
                    key: "destroy",
                    value: function() {
                ...
                return _createClass(i, [{
                    ...
                    value: function(e) {
                        var t = void 0,
                            ...
                            n = void 0;
                        if (this.pressed)
                            if (t = this._xpos(e), i = this._ypos(e), n = this.reference - t, Math.abs(this.referenceY - i) < 30 && !this.verticalDragged)(n > 2 || n < -2) && (this.dragged = !0, this.reference = t, this._scroll(this.offset + n));
                            else {
                    ...
                    value: function(t) {
                        ...
                        var n = void 0,
                            ...
                            d = void 0,
                            c = this.center;
                        if (this.offset = "number" == typeof t ? t : this.offset, this.center = Math.floor((this.offset + this.dim / 2) / this.dim), a = this.offset - this.center * this.dim, o = a < 0 ? 1 : -1, r = -o * a * 2 / this.dim, s = this.count >> 1, this.options.fullWidth ? h = "translateX(0)" : (h = "translateX(" + (this.el.clientWidth - this.itemWidth) / 2 + "px) ", h += "translateY(" + (this.el.clientHeight - this.itemHeight) / 2 + "px)"), this.showIndicators) {
                    ...
                    value: function(e, t) {
                        ...
                        this.noWrap || (i < 0 ? Math.abs(i + this.count) < Math.abs(i) && (i += this.count) : i > 0 && Math.abs(i - this.count) < i && (i -= this.count)), this.target = this.dim * Math.round(this.offset / this.dim), i < 0 ? this.target += this.dim * Math.abs(i) : i > 0 && (this.target -= this.dim * i), "function" == typeof t && (this.oneTimeCallback = t), this.offset !== this.target && (this.amplitude = this.target - this.offset, this.timestamp = Date.now(), requestAnimationFrame(this._autoScrollBound))
                    }
                }, {
                    key: "next",
                    value: function(e) {
    ...
    function(e) {
        ...
        var t = {},
            i = function() {
                function i(t, n) {
                    _classCallCheck(this, i), t.M_FeatureDiscovery && t.M_FeatureDiscovery.destroy(), this.el = t, this.$el = e(t), this.el.M_FeatureDiscovery = this, this.options = e.extend({}, i.defaults, n), this.isOpen = !1, this.$origin = e("#" + this.$el.attr("data-target")), this._setup(), this._calculatePositioning(), this._setupEventHandlers()
                }
                return _createClass(i, [{
                    key: "destroy",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        var s = this.$origin.outerWidth(),
                            ...
                            D = g / 2 - $ / 2,
                            O = {};
                        O.top = v ? _ + "px" : "", O.right = p ? l - k - g + "px" : "", O.bottom = f ? h - _ - y + "px" : "", O.left = c ? k + "px" : "", O.position = b, e(this.wrapper).css(O), e(this.contentEl).css({
                            width: w + "px",
                            height: C + "px",
                            top: E + "px",
                            right: "0px",
                    ...
                    key: "open",
                    value: function() {
                        this.isOpen || (this.isOpen = !0, this.wrapper.classList.add("open"), document.body.addEventListener("click", this._handleDocumentClickBound, !0))
                    }
                }, {
                    key: "close",
                    value: function() {
                        this.isOpen && (this.isOpen = !1, this.wrapper.classList.remove("open"), document.body.removeEventListener("click", this._handleDocumentClickBound, !0))
                    }
                }], [{
                    key: "init",
                    value: function(e, t) {
    ...
    function(e) {
        ...
        var t = {
            ...
            i = function() {
                function i(t, n) {
                    _classCallCheck(this, i), t.M_Select && t.M_Select.destroy(), this.el = t, this.$el = e(t), this.el.M_Select = this, this.options = e.extend({}, i.defaults, n), this.isMultiple = this.$el.prop("multiple"), this.valuesSelected = [], this.$selectedOptions = e(), this._setupDropdown(), this._setupEventHandlers()
                }
                return _createClass(i, [{
                    key: "destroy",
                    value: function() {
                        this._removeEventHandlers(), this._removeDropdown(), this.el.M_Select = void 0
                    }
                }, {
                    key: "_setupEventHandlers",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        }), this.el.removeEventListener("change", this._handleSelectChangeBound), this.input.removeEventListener("click", this._handleInputClickBound), this.input.removeEventListener("focus", this._handleInputFocusBound)
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        if (!e(i).hasClass("disabled") && !e(i).hasClass("optgroup")) {
                            ...
                            } else e(this.dropdownOptions).find("li").removeClass("active"), e(i).toggleClass("active"), this.input.value = i.textContent;
                            this._activateOption(e(this.dropdownOptions), i), this.$el.find("option").eq(n).prop("selected", s), this.$el.trigger("change")
                        }
                        t.stopPropagation()
                    }
                }, {
                    ...
                    value: function() {
                        var t = this;
                        this.wrapper = document.createElement("div"), this.wrapper.classList.add(), e(this.wrapper).addClass("select-wrapper " + this.options.classes), this.$el.before(e(this.wrapper)), this.wrapper.appendChild(this.el), this.el.disabled && this.wrapper.classList.add("disabled"), this.$selectOptions = this.$el.children("option, optgroup"), this.dropdownOptions = document.createElement("ul"), this.dropdownOptions.id = "select-options-" + M.guid(), e(this.dropdownOptions).addClass("dropdown-content select-dropdown " + (this.isMultiple ? "multiple-select-dropdown" : "")), this.$selectOptions.length && this.$selectOptions.each(function(i) {
                            if (e(i).is("option")) {
                                var n = void 0;
                                n = t.isMultiple ? t._appendOptionWithIcon(t.$el, i, "multiple") : t._appendOptionWithIcon(t.$el, i), e(i).prop("selected") && t.$selectedOptions.add(n)
                            } else if (e(i).is("optgroup")) {
                                var s = e(i).children("option");
                                e(t.dropdownOptions).append(e('<li class="optgroup"><span>' + i.getAttribute("label") + "</span></li>")[0]), s.each(function(i) {
                        ...
                        if (this.$el.before(i[0]), !this.el.disabled) {
                            var n = {};
                            this.isMultiple && (n.closeOnClick = !1), this.dropdown = new M.Dropdown(this.input, n)
                        }
                    ...
                    value: function(t, i, n) {
                        var s = i.disabled ? "disabled " : "",
                            ...
                            r = e("<li></li>"),
                            l = e("<span></span>");
                        l.html(o), r.addClass(s + " " + a), r.append(l);
                    ...
                    value: function(t) {
                        var i = this.valuesSelected.indexOf(t),
                            n = -1 === i;
                        return n ? this.valuesSelected.push(t) : this.valuesSelected.splice(i, 1), e(this.dropdownOptions).find("li:not(.optgroup)").eq(t).toggleClass("active"), this.$el.find("option").eq(t).prop("selected", n), n
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this.$el.find("option").each(function(n, s) {
                            var a = i.eq(s);
                            e(n).prop("selected") ? (a.find('input[type="checkbox"]').prop("checked", !0), t._activateOption(e(t.dropdownOptions), a), t.valuesSelected.push(s)) : (a.find('input[type="checkbox"]').prop("checked", !1), a.removeClass("selected"))
                        })
                    }
                }, {
                    key: "_activateOption",
        ...
        M.Select = i, M.jQueryLoaded && M.initializeJqueryWrapper(i, "select", "M_Select")
    }(cash),
    function(e, t) {
        "use strict";
        var i = {},
            n = function() {
                function n(t, i) {
                    _classCallCheck(this, n), t.M_Range && t.M_Range.destroy(), this.el = t, this.$el = e(t), this.el.M_Range = this, this.options = e.extend({}, n.defaults, i), this._mousedown = !1, this._setupThumb(), this._setupEventHandlers()
                }
                return _createClass(n, [{
                    key: "destroy",
                    value: function() {
                    ...
                    value: function() {
                        if (!this._mousedown) {
                            ...
                            e(this.thumb).hasClass("active") && (t(this.thumb, "stop"), t(this.thumb, {
                                height: "0px",
                                width: "0px",
                                top: "10px",
                                marginLeft: i
